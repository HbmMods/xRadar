...
public class TransformGroupBone extends TransformGroup {
    ...
    public Angle3D getTransformAngle() {
        Angle3D returnAngle = attachedBone.getAbsoluteAngle()
            .copy();
    ...
    public Vec3 doTransformation(PositionTransformVertex vertex) {
        Vec3 vector = Vec3
            .createVectorHelper(vertex.neutralVector.xCoord, vertex.neutralVector.yCoord, vertex.neutralVector.zCoord);
