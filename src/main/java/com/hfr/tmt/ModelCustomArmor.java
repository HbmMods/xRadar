...
public class ModelCustomArmor extends ModelBiped {
    ...
    // public ModelRendererTurbo[] skirtFrontModel = new ModelRendererTurbo[0]; //Acts like a leg piece, but its pitch
    // is set to the maximum of the two legs
    // public ModelRendererTurbo[] skirtRearModel = new ModelRendererTurbo[0]; //Acts like a leg piece, but its pitch is
    // set to the minimum of the two legs
