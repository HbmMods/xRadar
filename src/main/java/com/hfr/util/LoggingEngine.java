...
public class LoggingEngine {
    ...
    public static void log(String message) {
        ...
        // Date now = new Date();
        // String timestamp = String.format("[%s:%s:%s.%s]", Calendar.HOUR_OF_DAY, Calendar.MINUTE, Calendar.SECOND,
    ...
    public static void survey() {
        ...
        if (ridden == null) {
            ...
            String className = ridden.getClass()
                .getSimpleName();
        ...
        List<Entity> proximity = world.getEntitiesWithinAABBExcludingEntity(
            player,
        ...
        for (Entity proxmox : proximity) {
            ...
            String proximity_className = proxmox.getClass()
                .getSimpleName();
        ...
        NetworkManager netman = Minecraft.getMinecraft()
            .getNetHandler()
            .getNetworkManager();
        ...
        if (inboundpackets == null) {
            ...
            for (Object o : inboundpackets) {
                ...
                if (!(o instanceof FMLProxyPacket)) {
                    log(
                        "[Packets Inbound] Detected packet" + o.getClass()
                            .getSimpleName());
                    ...
                    if (o instanceof S1BPacketEntityAttach) {
                        ...
                        String dead1 = victim1 == null ? "NULL"
                            : victim1.getClass()
                                .getSimpleName();
                        String dead2 = victim2 == null ? "NULL"
                            : victim2.getClass()
                                .getSimpleName();

                        log(
                            "[Baphomet Packet] Attempted to mount index " + ent1
                                + " belonging to "
                                + dead1
                                + " to index "
                                + ent2
