            ...
            if (te != null && te instanceof TileEntityMachineSiren) {
                ...
                if (m.active) {
                    ...
                    if (sound == null) {
                        // Start sound
                        if (m.id > 0) {
                            boolean b = TrackType.getEnum(m.id)
                                .getType()
                                .name()
                                .equals(SoundType.LOOP.name());
                            SoundLoopSiren s = new SoundLoopSiren(
                                TrackType.getEnum(m.id)
                                    .getSoundLocation(),
                                te,
                                TrackType.getEnum(m.id)
                                    .getType());
                            s.setRepeat(b);
                            s.intendedVolume = TrackType.getEnum(m.id)
                                .getVolume();
                        ...
                        ResourceLocation loc = TrackType.getEnum(m.id)
                            .getSoundLocation();
                        ...
                        if (loc != null) {
                            ...
                            if (!sound.getPath()
                                ...
                                sound.endSound();
                                if (m.id > 0) Minecraft.getMinecraft()
                                    .getSoundHandler()
                                    .playSound(
                                        new SoundLoopSiren(
                                            TrackType.getEnum(m.id)
                        ...
                        sound.intendedVolume = TrackType.getEnum(m.id)
                            .getVolume();
                    }
