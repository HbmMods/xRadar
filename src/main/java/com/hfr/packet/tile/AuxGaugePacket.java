        ...
        public IMessage onMessage(AuxGaugePacket m, MessageContext ctx) {
            try {
                ...
                if (te != null && te instanceof TileEntityMachineDerrick) {
                    ...
                    if (m.meta == 0) gen.oil = m.value;
                    if (m.meta == 1) gen.gas = m.value;
                }
                ...
                if (te != null && te instanceof TileEntityMachineRefinery) {
                    ...
                    if (m.meta == 0) gen.oil = m.value;
                    if (m.meta == 1) gen.heavy = m.value;
                    if (m.meta == 2) gen.naph = m.value;
                    if (m.meta == 3) gen.light = m.value;
                    if (m.meta == 4) gen.petro = m.value;
                }
                ...
                if (te != null && te instanceof TileEntityTank) {
                    ...
                    if (m.meta == 0) gen.fill = m.value;
                    if (m.meta == 1) gen.type = m.value;
                }
                ...
                if (te != null && te instanceof TileEntityNaval) {
                    ...
                    if (m.meta == 0) gen.powder = m.value;
                }
