...
public class TileEntityHydro extends TileEntity implements ISidedInventory {
            ...
            for (int j = -maxHeight; j <= maxHeight; j++) {
                ...
                if (this.getBlockMetadata() == 3) {
                    ...
                    if (b == ModBlocks.hydro_core && !(i == 0 && j == 0)) {
                        ...
                        if (worldObj.getBlock(xCoord + 1, yCoord + j, zCoord + i)
                            .getMaterial() == Material.water
                            && validFront(worldObj.getBlock(xCoord - 1, yCoord + j, zCoord + i), i % 2 == 0)) counter++;
                        else if (validFront(worldObj.getBlock(xCoord + 1, yCoord + j, zCoord + i), i % 2 == 0)
                            && worldObj.getBlock(xCoord - 1, yCoord + j, zCoord + i)
                                .getMaterial() == Material.water)
                            counter++;
                    }
                    ...
                    if (b == ModBlocks.hydro_core && !(i == 0 && j == 0)) {
                        ...
                        if (worldObj.getBlock(xCoord + i, yCoord + j, zCoord + 1)
                            .getMaterial() == Material.water
                            && validFront(worldObj.getBlock(xCoord + i, yCoord + j, zCoord - 1), i % 2 == 0)) counter++;
                        else if (validFront(worldObj.getBlock(xCoord + i, yCoord + j, zCoord + 1), i % 2 == 0)
                            && worldObj.getBlock(xCoord + i, yCoord + j, zCoord - 1)
                                .getMaterial() == Material.water)
                            counter++;
                    }
                }
    ...
    public int getTurbineNr() {
        ...
        if (this.getBlockMetadata() == 3) {
            ...
            for (int i = 1; i < maxWidth; i++) {
                ...
                if (b != ModBlocks.hydro_wall && b != ModBlocks.hydro_turbine) break;

                if (b == ModBlocks.hydro_wall) continue;

                if (i % 2 == 0 && b == ModBlocks.hydro_turbine) {

                    if (checkTurbineSeg(xCoord, zCoord + i)) counter++;
                }
            }
            ...
            for (int i = 1; i < maxWidth; i++) {
                ...
                if (i % 2 == 0 && b == ModBlocks.hydro_turbine) {
                    ...
                    if (checkTurbineSeg(xCoord + i, zCoord)) counter++;
                }
            }
    ...
    private boolean validFront(Block b, boolean seg) {
        ...
        if (seg && b.getMaterial() == Material.water) return true;
