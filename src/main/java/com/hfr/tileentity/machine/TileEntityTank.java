    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (fill == 0 && slots[0] != null) {
                ...
                if (slots[0].getItem() == ModItems.canister_oil) type = FLUID_OIL;
                if (slots[0].getItem() == ModItems.gas_natural) type = FLUID_GAS;
                if (slots[0].getItem() == ModItems.canister_petroil) type = FLUID_HEAVY;
                if (slots[0].getItem() == ModItems.canister_diesel) type = FLUID_DIESEL;
                if (slots[0].getItem() == ModItems.canister_kerosene) type = FLUID_KEROSENE;
                if (slots[0].getItem() == ModItems.gas_petroleum) type = FLUID_PETROLEUM;
            }
            ...
            switch (type) {
                case FLUID_GAS:
                    full = ModItems.gas_natural;
                    empty = ModItems.gas_empty;
                    break;
                case FLUID_PETROLEUM:
                    full = ModItems.gas_petroleum;
                    empty = ModItems.gas_empty;
                    break;
                case FLUID_HEAVY:
                    full = ModItems.canister_petroil;
                    break;
                case FLUID_DIESEL:
                    full = ModItems.canister_diesel;
                    break;
                case FLUID_KEROSENE:
                    full = ModItems.canister_kerosene;
                    break;
            }
            ...
            if (slots[0] != null && slots[0].getItem() == full && fill + 1000 <= maxFill) {
                ...
                if (slots[1] != null && slots[1].getItem() == empty
