...
public class TileEntityMachineGrainmill extends TileEntityMachineBase {
    ...
    public boolean operational() {
        ...
        for (int i = -1; i <= 1; i++)
            for (int j = -1; j <= 1; j++) if (worldObj.getBlock(xCoord + i, yCoord + 6, zCoord + j)
                .getMaterial() != Material.air && !(i == 0 && j == 0)
                || !worldObj.canBlockSeeTheSky(xCoord + i, yCoord + 6, zCoord + j)) return false;
    ...
    public boolean hasWheat() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if ((slots[i] != null && slots[i].getItem() == Items.wheat)) return true;
        }
    ...
    public boolean hasSpace() {
        ...
        for (int i = 3; i < 6; i++) {
            ...
            if ((slots[i] == null || (slots[i] != null && slots[i].getItem() == ModItems.flour
    ...
    public void addFlour() {
        ...
        for (int i = 3; i < 6; i++) {
            ...
            if (slots[i] != null && slots[i].getItem() == ModItems.flour
