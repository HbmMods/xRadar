...
public class TileEntityMachineRefinery extends TileEntity implements ISidedInventory, IEnergyHandler {
    ...
    public EnergyStorage storage = new EnergyStorage(
        MainRegistry.refineryBuffer,
        MainRegistry.refineryBuffer / 100,
        MainRegistry.refineryBuffer / 100);
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (slots[3] != null && slots[3].getItem() == ModItems.canister_empty && heavy >= 1000) {
                ...
                if (slots[4] != null && slots[4].getItem() == ModItems.canister_petroil
                    && slots[4].stackSize < slots[4].getMaxStackSize()) {
            ...
            if (slots[5] != null && slots[5].getItem() == ModItems.canister_empty && naph >= 1000) {
                ...
                if (slots[6] != null && slots[6].getItem() == ModItems.canister_diesel
                    && slots[6].stackSize < slots[6].getMaxStackSize()) {
            ...
            if (slots[7] != null && slots[7].getItem() == ModItems.canister_empty && light >= 1000) {
                ...
                if (slots[8] != null && slots[8].getItem() == ModItems.canister_kerosene
                    && slots[8].stackSize < slots[8].getMaxStackSize()) {
            ...
            if (slots[9] != null && slots[9].getItem() == ModItems.gas_empty && petro >= 1000) {
                ...
                if (slots[10] != null && slots[10].getItem() == ModItems.gas_petroleum
                    && slots[10].stackSize < slots[10].getMaxStackSize()) {
            ...
            if (slots[1] != null && slots[1].getItem() == ModItems.canister_oil && oil <= maxOil - 1000) {
                ...
                if (slots[2] != null && slots[2].getItem() == ModItems.canister_empty
