...
public class TileEntityMachineUni extends TileEntityMachineBase {
        ...
        if (!worldObj.isRemote) {
            ...
            if (operational() && hasSpace() && slots[4] == null) {
                ...
                if (worldObj.rand.nextInt(MainRegistry.uniRate * 20) == 0) {
                    ...
                    for (int i = 0; i < 4; i++) {
                        if (slots[i] == null) {
                            ...
                            break;
                        } else if (slots[i].getItem() == ModItems.science
                ...
                if (worldObj.rand.nextInt(MainRegistry.uniJamRate * 20) == 0) {
                    ...
                    if (i < 5) slots[4] = new ItemStack(Items.paper).setStackDisplayName("Student Strike");
                    else if (i < 7) slots[4] = new ItemStack(Items.gunpowder).setStackDisplayName("Bomb Threat");
                    else if (i < 9) slots[4] = new ItemStack(Items.skull).setStackDisplayName("Workplace Accident");
                    else slots[4] = new ItemStack(Items.bone).setStackDisplayName("Skeleton Attack");
                }
            } else {
    ...
    public boolean hasSpace() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if ((slots[i] == null || (slots[i] != null && slots[i].getItem() == ModItems.science
