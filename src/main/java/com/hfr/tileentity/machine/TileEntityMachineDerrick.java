...
public class TileEntityMachineDerrick extends TileEntity implements ISidedInventory, IEnergyHandler {
    ...
    public EnergyStorage storage = new EnergyStorage(
        MainRegistry.derrickBuffer,
        MainRegistry.derrickBuffer / 100,
        MainRegistry.derrickBuffer / 100);
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (slots[1] != null && slots[1].getItem() == ModItems.canister_empty && oil >= 1000) {
                ...
                if (slots[2] != null && slots[2].getItem() == ModItems.canister_oil
            ...
            if (slots[3] != null && slots[3].getItem() == ModItems.gas_empty && gas >= 1000) {
                ...
                if (slots[4] != null && slots[4].getItem() == ModItems.gas_natural
                    ...
                    for (int i = this.yCoord - 1; i > this.yCoord - 1 - 100; i--) {
                        ...
                        if ((b == ModBlocks.ore_oil || b == ModBlocks.ore_oil_empty) && oil < maxOil && gas < maxGas) {
                            if (succ(this.xCoord, i, this.zCoord)) {
                                ...
                                // ExplosionLarge.spawnOilSpills(worldObj, xCoord + 0.5F, yCoord + 5.5F, zCoord + 0.5F,
                                // 3);
    ...
    private void pipe(boolean bool) {
        ...
        for (int i = this.yCoord - 1; i > this.yCoord - 1 - 100; i--) {
            ...
            if (b == Blocks.air || b == Blocks.grass
                || b == Blocks.dirt
                || (b == ModBlocks.ore_oil_empty && token)
                || b == Blocks.stone
                || b == Blocks.sand
                || b == Blocks.sandstone
                || b == Blocks.clay
    ...
    public void succ1(int x, int y, int z) {
        ...
        steps++;
        if (steps > MainRegistry.derrickLimiter) return;
