...
public class TileEntityVaultDoor extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            for (int x = xCoord - 2; x <= xCoord + 2; x++)
                for (int y = yCoord; y <= yCoord + 5; y++) if (worldObj.isBlockIndirectlyGettingPowered(x, y, zCoord)) {
                    flagX = true;
                    break;
                }

            for (int z = zCoord - 2; z <= zCoord + 2; z++)
                for (int y = yCoord; y <= yCoord + 5; y++) if (worldObj.isBlockIndirectlyGettingPowered(xCoord, y, z)) {
                    flagZ = true;
                    break;
                }
            ...
            if (worldObj.getBlockMetadata(xCoord, yCoord, zCoord) == 4
                || worldObj.getBlockMetadata(xCoord, yCoord, zCoord) == 5) {
                if (flagZ) {
            ...
            if (isOpening && state == 1) {
                if (timer == 0) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultScrapeNew", 1.0F, 1.0F);
                if (timer == 45) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 55) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 65) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 75) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 85) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 95) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 105) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 115) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
            }
            if (!isOpening && state == 1) {
                ...
                if (timer == 0) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 10) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 20) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 30) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 40) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 50) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 60) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);
                if (timer == 70) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultThudNew", 1.0F, 1.0F);

                if (timer == 80) this.worldObj
                    .playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.vaultScrapeNew", 1.0F, 1.0F);
            }
    ...
    public boolean placeDummy(int x, int y, int z) {
        ...
        if (!worldObj.getBlock(x, y, z)
            .isReplaceable(worldObj, x, y, z)) return false;
    ...
    private boolean isHatchFree() {
        ...
        if (this.getBlockMetadata() == 2 || this.getBlockMetadata() == 3) return checkNS();
        else if (this.getBlockMetadata() == 4 || this.getBlockMetadata() == 5) return checkEW();
        else return true;
    }

    private void closeHatch() {

        if (this.getBlockMetadata() == 2 || this.getBlockMetadata() == 3) fillNS();
        else if (this.getBlockMetadata() == 4 || this.getBlockMetadata() == 5) fillEW();
    }

    private void openHatch() {

        if (this.getBlockMetadata() == 2 || this.getBlockMetadata() == 3) removeNS();
        else if (this.getBlockMetadata() == 4 || this.getBlockMetadata() == 5) removeEW();
    }

    private boolean checkNS() {
        return worldObj.getBlock(xCoord - 1, yCoord + 1, zCoord)
            .isReplaceable(worldObj, xCoord - 1, yCoord + 1, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 1, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord + 1, zCoord)
            && worldObj.getBlock(xCoord + 1, yCoord + 1, zCoord)
                .isReplaceable(worldObj, xCoord + 1, yCoord + 1, zCoord)
            && worldObj.getBlock(xCoord - 1, yCoord + 2, zCoord)
                .isReplaceable(worldObj, xCoord - 1, yCoord + 2, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 2, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord + 2, zCoord)
            && worldObj.getBlock(xCoord + 1, yCoord + 2, zCoord)
                .isReplaceable(worldObj, xCoord + 1, yCoord + 2, zCoord)
            && worldObj.getBlock(xCoord - 1, yCoord + 3, zCoord)
                .isReplaceable(worldObj, xCoord - 1, yCoord + 3, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 3, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord + 3, zCoord)
            && worldObj.getBlock(xCoord + 1, yCoord + 3, zCoord)
                .isReplaceable(worldObj, xCoord + 1, yCoord + 3, zCoord);
    }

    private boolean checkEW() {
        return worldObj.getBlock(xCoord, yCoord + 1, zCoord - 1)
            .isReplaceable(worldObj, xCoord, yCoord + 1, zCoord - 1)
            && worldObj.getBlock(xCoord, yCoord + 1, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 1, zCoord + 1)
                .isReplaceable(worldObj, xCoord, yCoord + 1, zCoord + 1)
            && worldObj.getBlock(xCoord, yCoord + 2, zCoord - 1)
                .isReplaceable(worldObj, xCoord, yCoord + 2, zCoord - 1)
            && worldObj.getBlock(xCoord, yCoord + 2, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord + 2, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 2, zCoord + 1)
                .isReplaceable(worldObj, xCoord, yCoord + 2, zCoord + 1)
            && worldObj.getBlock(xCoord, yCoord + 3, zCoord - 1)
                .isReplaceable(worldObj, xCoord, yCoord + 3, zCoord - 1)
            && worldObj.getBlock(xCoord, yCoord + 3, zCoord)
                .isReplaceable(worldObj, xCoord, yCoord + 3, zCoord)
            && worldObj.getBlock(xCoord, yCoord + 3, zCoord + 1)
                .isReplaceable(worldObj, xCoord, yCoord + 3, zCoord + 1);
