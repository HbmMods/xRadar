...
public class TileEntityBlastDoor extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord, zCoord)
                || worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord + 6, zCoord)) {
            ...
            PacketDispatcher.wrapper.sendToAllAround(
                new TEVaultPacket(xCoord, yCoord, zCoord, isOpening, state, 0, 0),
                new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 250));
        }
    }
    ...
    public void open() {
        if (state == 0) {
            PacketDispatcher.wrapper.sendToAllAround(
                new TEVaultPacket(xCoord, yCoord, zCoord, isOpening, state, 1, 0),
                new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 250));
            isOpening = true;
            state = 1;

            this.worldObj.playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.reactorStart", 0.5F, 0.75F);
        }
    }
    ...
    public void finishOpen() {
        ...
        this.worldObj.playSoundEffect(this.xCoord, this.yCoord, this.zCoord, "hfr:block.reactorStop", 0.5F, 1.0F);
    }
