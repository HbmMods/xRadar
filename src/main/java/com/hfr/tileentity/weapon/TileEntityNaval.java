...
public class TileEntityNaval extends TileEntity implements ISidedInventory {
    ...
    public boolean setAngles(boolean miss) {
        ...
        if (slots[1] != null
            ...
            if (vec.lengthVector() < 1 || vec.lengthVector() > 4950) return false;
    ...
    public boolean canFire() {
        ...
        return slots[2] != null
            && (slots[2].getItem() == ModItems.charge_naval || slots[2].getItem() == ModItems.charge_at)
            && powder >= 30 * 64;
    }
    ...
    public void fire() {
        ...
        if (slots[2].getItem() == ModItems.charge_naval) fart.raiding = true;
        else fart.raiding = false;
