...
public class TileEntityFlagBig extends TileEntityMachineBase implements ITerritoryProvider {
            ...
            if (owner == null) {
                ...
                if (slots[1] != null) {
                    ...
                    if (worldObj.rand.nextInt(60 * 20) == 0) {
                        ...
                        } else if (slots[0].getItem() == slots[1].getItem()
    ...
    public void generateClaim() {
        ...
        for (CoordPair coords : this.claim) {
            ...
            else ClowderTerritory.removeZoneForCoord(worldObj, coords);
        }
    }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        for (int i = 0; i < length; i++) {
            this.claim.add(new CoordPair(nbt.getInteger("x" + i), nbt.getInteger("z" + i)));
        }
    }
