...
public class TileEntityConquerer extends TileEntityMachineBase implements ITerritoryProvider {
        ...
        if (!worldObj.isRemote) {
            ...
            if (!Clowder.clowders.contains(owner) && owner != null) {
                MainRegistry.logger.info(
                    "Deleting clowder from conquerer " + xCoord
                        + " "
                        + yCoord
                        + " "
                        + zCoord
    ...
    public boolean canSeeSky() {
        ...
        if (!worldObj.canBlockSeeTheSky(xCoord, yCoord, zCoord)) return false;
        /*
         * if(yCoord < 45)
         * return false;
         * if(yCoord > 100)
    ...
    private void conquer() {
        ...
        if (meta != null && meta.owner.zone == Zone.FACTION
            && meta.owner.owner != this.owner/* && meta.owner.owner.isRaidable() */) {
