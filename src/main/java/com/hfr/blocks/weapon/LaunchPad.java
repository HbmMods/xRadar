...
public class LaunchPad extends BlockContainer {
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_,
        int p_149749_6_) {
        if (!keepInventory) {
            TileEntityLaunchPad tileentityfurnace = (TileEntityLaunchPad) p_149749_1_
        ...
        //
        {
            if (entity.slots[1] != null
                && (entity.slots[1].getItem() == ModItems.designator
                    || entity.slots[1].getItem() == ModItems.designator_range
                    || entity.slots[1].getItem() == ModItems.designator_manual)
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_at_1
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileAT missile = new EntityMissileAT(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                        xCoord,
                        zCoord);
                    if (!p_149695_1_.isRemote) p_149695_1_.spawnEntityInWorld(missile);
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_he_1
                    && entity.storage.getEnergyStored() >= re) {
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_he_2
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileStrong missile = new EntityMissileStrong(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_he_3
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileBurst missile = new EntityMissileBurst(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_incendiary_1
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileIncendiary missile = new EntityMissileIncendiary(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_incendiary_2
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileIncendiaryStrong missile = new EntityMissileIncendiaryStrong(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_incendiary_3
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileInferno missile = new EntityMissileInferno(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_emp
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileEMPStrong missile = new EntityMissileEMPStrong(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_decoy
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileDecoy missile = new EntityMissileDecoy(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_nuclear
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileNuclear missile = new EntityMissileNuclear(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_devon_1
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileDevon1 missile = new EntityMissileDevon1(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_devon_2
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileDevon2 missile = new EntityMissileDevon2(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_devon_3
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileDevon3 missile = new EntityMissileDevon3(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
                ...
                if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_cruise_at_1
                    && entity.storage.getEnergyStored() >= re) {
                    EntityMissileCruise1 missile = new EntityMissileCruise1(
                        p_149695_1_,
                        x + 0.5F,
                        y + 2F,
                        z + 0.5F,
            ...
            if (entity.slots[0] != null && entity.slots[0].getItem() == ModItems.missile_ab
                && entity.storage.getEnergyStored() >= re) {
