...
public class MachineTank extends BlockContainer {

	protected MachineTank(Material p_i45386_1_) {
		super(p_i45386_1_);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		{
			FMLNetworkHandler.openGui(player, MainRegistry.instance, ModBlocks.guiID_tank, world, x, y, z);
			return true;
		} else {
			return true;
		}
