...
public class BlockDuct extends BlockContainer {
	...
	protected BlockDuct(Material p_i45386_1_) {
		super(p_i45386_1_);
		float p = 1F/16F;
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int x, int y, int z) {
		if(world.getTileEntity(x, y, z) instanceof TileEntityDuct) {
			TileEntityDuct cable = (TileEntityDuct)world.getTileEntity(x, y, z);
