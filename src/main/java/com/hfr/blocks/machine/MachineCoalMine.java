...
public class MachineCoalMine extends BlockDummyable {

    public MachineCoalMine(Material mat) {
        super(mat);
    }
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        ...
        if (meta >= ForgeDirection.UNKNOWN.ordinal()) return new TileEntityMachineCoalMine();
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler
                .openGui(player, MainRegistry.instance, ModBlocks.guiID_coalmine, world, pos[0], pos[1], pos[2]);
            return true;
        } else {
            return true;
        }
