...
public class MachineFactory extends BlockDummyable {

    public MachineFactory(Material p_i45386_1_) {
        super(p_i45386_1_);
    }
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        ...
        if (meta >= 12) return new TileEntityMachineFactory();
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler
                .openGui(player, MainRegistry.instance, ModBlocks.guiID_factory, world, pos[0], pos[1], pos[2]);
            return true;
        } else {
            return true;
        }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
        ...
        if (k == 0) dir = ForgeDirection.getOrientation(2);
        if (k == 1) dir = ForgeDirection.getOrientation(5);
        if (k == 2) dir = ForgeDirection.getOrientation(3);
        if (k == 3) dir = ForgeDirection.getOrientation(4);
