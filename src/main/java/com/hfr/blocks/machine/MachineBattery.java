...
public class MachineBattery extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        this.blockIcon = iconRegister.registerIcon(RefStrings.MODID + ":battery_side");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler.openGui(player, MainRegistry.instance, ModBlocks.guiID_battery, world, x, y, z);
            return true;
        } else {
            return true;
        }
