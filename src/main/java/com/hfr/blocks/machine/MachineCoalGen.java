...
public class MachineCoalGen extends BlockContainer {

    public MachineCoalGen(Material p_i45386_1_) {
        super(p_i45386_1_);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler.openGui(player, MainRegistry.instance, ModBlocks.guiID_coalgen, world, x, y, z);
            return true;
        } else {
            return true;
        }
