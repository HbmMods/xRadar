...
public class MachineUni extends BlockDummyable {
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        ...
        if (meta >= ForgeDirection.UNKNOWN.ordinal()) return new TileEntityMachineUni();
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler
                .openGui(player, MainRegistry.instance, ModBlocks.guiID_uni, world, pos[0], pos[1], pos[2]);
            return true;
        } else {
            return true;
        }
