...
public class MachineBlastFurnace extends BlockDummyable {
    ...
    public MachineBlastFurnace(Material mat) {
        super(mat);
    }
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        ...
        if (meta >= ForgeDirection.UNKNOWN.ordinal()) return new TileEntityMachineBlastFurnace();
    ...
    public int[] getDimensions() {
        return MultiblockHandler.furnace;
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.isRemote) {
            ...
            FMLNetworkHandler
                .openGui(player, MainRegistry.instance, ModBlocks.guiID_blastfurnace, world, pos[0], pos[1], pos[2]);
            return true;
        } else {
            return true;
        }
    ...
    public void breakBlock(World world, int x, int y, int z, Block p_149749_5_, int i) {
        ...
        if (i >= ForgeDirection.UNKNOWN.ordinal()) {
            ...
            if (owner != null && owner.zone == Zone.FACTION) {
                ...
                if (statue.operational()) owner.owner.addPrestigeGen(-Clowder.tentRate, world);
            }
        }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
        ...
        if (world.getBlock(xc, y, zc) == this && world.getBlockMetadata(xc, y, zc) > 11) {
            this.safeRem = true;
            if (world.getBlock(xc, y + 1, zc) == this) world.setBlock(xc, y + 1, zc, Blocks.air);
            if (world.getBlock(xc, y + 2, zc) == this) world.setBlock(xc, y + 2, zc, Blocks.air);
            if (world.getBlock(xc, y + 3, zc) == this) world.setBlock(xc, y + 3, zc, Blocks.air);
            if (world.getBlock(xc, y + 4, zc) == this) world.setBlock(xc, y + 4, zc, Blocks.air);
            this.safeRem = false;
        }
    }
