...
public class StockData extends WorldSavedData {
    ...
    public int getShares(String player, Stock stock) {
        ...
        for (StockEntry entry : entries) {
            if (entry.player.equals(player) && entry.stock == stock) return entry.shares;
        }
    ...
    public Stock getStockByShort(String shortname) {
        ...
        for (Stock stock : stocks) {
            if (stock.shortname.equals(shortname)) return stock;
        }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        for (int i = 0; i < stocks.size(); i++) stocks.get(i)
            .readFromNBT(nbt, i);
    ...
    public static class Stock {
        ...
        public Stock(String name, String shortname, float value, float u2chance, float u1chance, float nchance,
            float d1chance, float d2chance) {
            this.name = name;
            ...
            for (int i = 0; i < 15; i++) this.value[i] = value;
        }
        ...
        public void writeToNBT(NBTTagCompound nbt, int index) {
            ...
            for (int i = 0; i < 15; i++) nbt.setFloat(index + "_" + i + "_value", value[i]);
        }

        public void readFromNBT(NBTTagCompound nbt, int index) {

            for (int i = 0; i < 15; i++) value[i] = nbt.getFloat(index + "_" + i + "_value");
        }
