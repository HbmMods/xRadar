...
public class TomPronter {
    ...
    public static void prontTom(int type) {
        ...
        TextureManager tex = Minecraft.getMinecraft()
            .getTextureManager();
        ...
        if (type == 0) tex.bindTexture(ResourceManager.tom_flame_tex);
        if (type == 1) tex.bindTexture(ResourceManager.tom_flame_o_tex);
