...
public class RenderDuct extends TileEntitySpecialRenderer {

    public ResourceLocation oil = new ResourceLocation(RefStrings.MODID, "textures/blocks/oil_duct.png");
    public ResourceLocation gas = new ResourceLocation(RefStrings.MODID, "textures/blocks/gas_duct.png");
    float pixel = 1F / 16F;
    ...
    public void renderTileEntityAt(TileEntity tileentity, double offsetX, double offsetY, double offsetZ, float f) {
        ...
        if (tileentity.getBlockType() == ModBlocks.oil_duct) this.bindTexture(oil);
        else this.bindTexture(gas);

        drawCore(tileentity);
        TileEntityDuct cable = (TileEntityDuct) tileentity;
    ...
    public void drawCore(TileEntity tileentity) {
        ...
        tesseract
            .addVertexWithUV(1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 5 * textureP, 0 * textureP);
        ...
        tesseract
            .addVertexWithUV(1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 0 * textureP, 0 * textureP);
        ...
        tesseract
            .addVertexWithUV(1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 5 * textureP, 5 * textureP);
        tesseract.addVertexWithUV(1 - 11 * pixel / 2, 1 - 11 * pixel / 2, 11 * pixel / 2, 5 * textureP, 0 * textureP);
        tesseract.addVertexWithUV(11 * pixel / 2, 1 - 11 * pixel / 2, 11 * pixel / 2, 0 * textureP, 0 * textureP);
        ...
        // Muehsam muss ich hier im BSH meine genialen Mods schreiben, obwohl ich die Zeit eigentlich doch besser nutzen
        // koennte.
        // Da mir das aber Spass macht, wird auch in Zukunft gutes Zeug von mir geben (und damit meine ich NICHT Drogen,
        // etc.)
        // Danke.
