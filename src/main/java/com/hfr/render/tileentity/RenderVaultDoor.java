...
public class RenderVaultDoor extends TileEntitySpecialRenderer {
    ...
    public void renderDoor(TileEntityVaultDoor tileEntity, double x, double y, double z, float f) {
        ...
        if (tileEntity.state == 0) timer = new double[] { 0, 0, 0, 0, 0 };
        else if (tileEntity.state == 2) timer = getAnimationFromSysTime((2000 + 800 * 5));
        else if (tileEntity.isOpening) timer = getAnimationFromSysTime(System.currentTimeMillis() - tileEntity.sysTime);
        else timer = getAnimationFromSysTime(tileEntity.sysTime + (2000 + 800 * 5) - System.currentTimeMillis());
        ...
        switch (tileEntity.type) {
            ...
            case 3:
            case 4:
                bindTexture(ResourceManager.stable_cog_tex);
                break;
            case 5:
            case 6:
                bindTexture(ResourceManager.vault4_cog_tex);
                break;
            case 7:
                bindTexture(ResourceManager.lvl9_cog_tex);
                break;
            default:
                bindTexture(ResourceManager.vault_cog_tex);
                break;
        ...
        switch (tileEntity.type) {
            case 1:
                bindTexture(ResourceManager.vault_label_87_tex);
                break;
            case 2:
                bindTexture(ResourceManager.vault_label_106_tex);
                break;
            case 3:
                bindTexture(ResourceManager.stable_label_tex);
                break;
            case 4:
                bindTexture(ResourceManager.stable_99_label_tex);
                break;
            case 5:
                bindTexture(ResourceManager.vault4_label_111_tex);
                break;
            case 6:
                bindTexture(ResourceManager.vault4_label_81_tex);
                break;
            case 7:
                bindTexture(ResourceManager.lvl9_label_tex);
                break;
            default:
                bindTexture(ResourceManager.vault_label_101_tex);
                break;
        }
