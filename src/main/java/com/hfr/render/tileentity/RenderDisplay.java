...
public class RenderDisplay extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float f) {
        ...
        minecraft.fontRenderer.drawString(
            "" + name,
            (int) ((120 - minecraft.fontRenderer.getStringWidth(name) / 2) * fontScale),
            (int) ((36) * fontScale),
            0xFFFFFF);
        minecraft.fontRenderer
            .drawString("" + round(min), (int) ((9) * fontScale), (int) ((83.5) * fontScale), 0xFFFFFF);

        float diff = (vals[14] - vals[13]) / vals[13] * 100;

        int color = 0xFF0000;

        if (diff > 0) color = 0x00FF00;
        if (diff == 0) color = 0xFFFF00;
        ...
        minecraft.fontRenderer.drawString(
            ...
            color);
        minecraft.fontRenderer
            .drawString("=" + round(vals[14]), (int) ((149.5) * fontScale), (int) ((48.5) * fontScale), 0xFFFFFF);
