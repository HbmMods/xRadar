    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        switch (type) {
            case ENTITY:
                 ...
                 * float f2 = MathHelper.sin(((float)it.age + MainRegistry.smoothing) / 10.0F + it.hoverStart) * 0.1F +
                 * 0.1F;
                 * float f3 = (((float)it.age + MainRegistry.smoothing) / 20.0F + it.hoverStart) * (180F /
                 * (float)Math.PI);
                 */
        ...
        if (open) GL11.glRotatef(45, 1, 0, 0);
