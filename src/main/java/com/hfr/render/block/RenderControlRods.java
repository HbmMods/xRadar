...
public class RenderControlRods implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        ObjUtil.renderWithIcon((WavefrontObject) ResourceManager.rbmk_rods_base, iicon, tessellator, 0, false);
