...
public class RenderFarmer extends RenderBiped {
    ...
    private static final ResourceLocation loc1 = new ResourceLocation(
        RefStrings.MODID,
        "textures/entity/vietnamese.png");
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        int i = entity.getDataWatcher()
            .getWatchableObjectInt(16);

        if (i == 0) return loc0;
        else if (i == 1) return loc1;
        else return loc2;
    }
