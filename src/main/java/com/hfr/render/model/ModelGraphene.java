...
public class ModelGraphene extends ModelCustomArmor {
    ...
    public ModelGraphene() {
        this.textureX = 150;
        this.textureY = 16;
        (this.bodyModel = new ModelRendererTurbo[8])[0] = new ModelRendererTurbo(
            (ModelBase) this,
            1,
            1,
            this.textureX,
