...
public class RenderRadarScreen {
    ...
    private static final ResourceLocation base = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/radarscreen.png");
    private static final ResourceLocation error = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/radarscreen_altitude.png");
    private static final ResourceLocation combat = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/radarscreen_zoom.png");

    private static final ResourceLocation blipGreen = new ResourceLocation(RefStrings.MODID + ":textures/hud/blip.png");
    private static final ResourceLocation blipCircle = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipLarge.png");
    private static final ResourceLocation blipX = new ResourceLocation(RefStrings.MODID + ":textures/hud/blipX.png");
    private static final ResourceLocation blipRed = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipRed.png");
    private static final ResourceLocation blipDanger = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipDanger.png");
    private static final ResourceLocation blipUnknown = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipUnknown.png");
    private static final ResourceLocation blipToaster = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/toaster.png");
    private static final ResourceLocation blipMissileUp = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipMissileUp.png");
    private static final ResourceLocation blipMissileDown = new ResourceLocation(
        RefStrings.MODID + ":textures/hud/blipMissileDown.png");
    ...
    public static void renderBlips(int marginX, int marginY, int size, double zLevel, float blipSize, float clamp,
        int range) {
        ...
        for (Blip blip : blips) {
            ...
            if (Math.sqrt(x + z) > size * 0.35) continue;
            ...
            switch (blip.type) {
                case 0:
                    minecraft.getTextureManager()
                        .bindTexture(blipGreen);
                    break;
                case 1:
                    minecraft.getTextureManager()
                        .bindTexture(blipCircle);
                    break;
                case 2:
                    minecraft.getTextureManager()
                        .bindTexture(blipX);
                ...
                case 4:
                    minecraft.getTextureManager()
                        .bindTexture(blipDanger);
                    break;
                case 5:
                    minecraft.getTextureManager()
                        .bindTexture(blipUnknown);
                    break;
                case 6:
                    minecraft.getTextureManager()
                        .bindTexture(blipMissileUp);
                    break;
                case 7:
                    minecraft.getTextureManager()
                        .bindTexture(blipMissileDown);
                    break;
                case 8:
                    minecraft.getTextureManager()
                        .bindTexture(blipAB);
        ...
        for (Blip blip : blips) {
            ...
            if (blip.type != 3) {
                minecraft.fontRenderer.drawString(
                    "" + Math.round(blip.y),
                    (int) (cX * fontScale + (int) (x * clamp * fontScale) - 6),
                    (int) (cY * fontScale + (int) (z * clamp * fontScale) + 4),
                    0xBBFFBB);
            } else {

                minecraft.fontRenderer.drawString(
                    "" + Math.round(blip.posX),
                    (int) (cX * fontScale + (int) (x * clamp * fontScale) - 12),
                    (int) (cY * fontScale + (int) (z * clamp * fontScale) + 4),
                    0xFFBBBB);
                minecraft.fontRenderer.drawString(
                    "" + Math.round(blip.posZ),
                    (int) (cX * fontScale + (int) (x * clamp * fontScale) - 12),
                    (int) (cY * fontScale + (int) (z * clamp * fontScale) + 12),
                    0xFFBBBB);
    ...
    public static void renderComapss(int marginX, int marginY, int size, double zLevel, float blipSize, float clamp) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) minecraft.getTextureManager()
                .bindTexture(north);
            if (i == 1) minecraft.getTextureManager()
                .bindTexture(west);
            if (i == 2) minecraft.getTextureManager()
                .bindTexture(south);
            if (i == 3) minecraft.getTextureManager()
                .bindTexture(east);
