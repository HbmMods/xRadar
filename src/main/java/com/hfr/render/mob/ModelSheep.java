...
public class ModelSheep extends ModelBase {
    ...
    public static class ModelSheepWooly extends ModelBase {
        ...
        public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_,
            ...
            this.WoollegFrontLeft.rotateAngleX = (MathHelper.cos(p_78086_2_ * 0.6662F + 3.1415927F) * 1.4F
                * p_78086_3_);
        ...
        public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
            ...
            this.WoollegFrontLeft.rotateAngleX = (MathHelper.cos(p_78087_1_ * 0.6662F + 3.1415927F) * 1.4F
                * p_78087_2_);
            this.WoollegBackLeft.rotateAngleX = this.WoollegFrontRight.rotateAngleX;
            this.WoollegBackRight.rotateAngleX = this.WoollegFrontLeft.rotateAngleX;
