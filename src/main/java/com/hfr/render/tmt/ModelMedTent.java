...
public class ModelMedTent extends ModelItemHolder // Same as Filename
{

    public static final ModelMedTent instance = new ModelMedTent();
    int textureX = 512;
    int textureY = 512;

    public ModelMedTent() // Same as Filename
    {
