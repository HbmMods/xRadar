...
public class ModelGrainmill extends ModelItemHolder // Same as Filename
{
    ...
    public void render(float rot) {
        ...
        for (int i = 0; i < baseModel.length; i++) {
            ...
            if (i > cap) baseModel[i].rotateAngleZ += rot;
