...
public class RenderMissileHuge extends Render {
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
        ...
        if (p_76986_1_ instanceof EntityMissileBurst) bindTexture(ResourceManager.missileHuge_HE_tex);
        if (p_76986_1_ instanceof EntityMissileInferno) bindTexture(ResourceManager.missileHuge_IN_tex);
        if (p_76986_1_ instanceof EntityMissileNuclear) bindTexture(ResourceManager.missileNuclear_tex);
