...
public class RenderMissileSpear extends Render {
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        if (entity instanceof EntityMissileDevon1) return ResourceManager.missile_devon1_tex;
        if (entity instanceof EntityMissileDevon2) return ResourceManager.missile_devon2_tex;
        if (entity instanceof EntityMissileDevon3) return ResourceManager.missile_devon3_tex;
        if (entity instanceof EntityMissileCruise1) return ResourceManager.missile_cruise_at1_tex;
