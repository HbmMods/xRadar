...
public class ClientProxy extends ServerProxy {
    ...
    public void registerRenderInfo() {
        ...
        RenderingRegistry
            .registerEntityRenderingHandler(EntityMissileIncendiaryStrong.class, new RenderMissileStrong());
        ...
        RenderingRegistry
            .registerEntityRenderingHandler(EntityGrenadeGas.class, new RenderSnowball(ModItems.grenade_gas));
        RenderingRegistry
            .registerEntityRenderingHandler(EntityGrenadeNuclear.class, new RenderSnowball(ModItems.grenade_nuclear));
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntitySheep.class,
            new RenderSheep(new ModelSheep(), new ModelSheepWooly(), 1.0F));
        RenderingRegistry
            .registerEntityRenderingHandler(EntityChicken.class, new RenderChicken(new ModelChicken(), 0.5F));
    ...
    public boolean isPressed(int id) {
        ...
        switch (id) {
            case 0:
                return toggleZoom.isPressed();
            case 1:
                return incScale.isPressed();
            case 2:
                return decScale.isPressed();
            case 3:
                return slbm.isPressed();
            case 4:
                return filter.isPressed();
            case 5:
                return markers.isPressed();
        }
    ...
    public void howDoIUseTheZOMG(World world, double posX, double posY, double posZ, int type) {
        ...
        switch (type) {
            ...
            case 0:
                ParticleContrail contrail = new ParticleContrail(
            ...
            case 1:
                ...
                break;
            case 2:
                EntityReddustFX fx1 = new EntityReddustFX(
                    world,
                    posX,
                    posY,
                    posZ,
                ...
                break;
            case 3:
                EntityReddustFX fx2 = new EntityReddustFX(
                    world,
                    posX,
                    posY,
                    posZ,
                ...
                break;
            case 4:
                EntityLargeExplodeFX fx3 = new EntityLargeExplodeFX(
                    Minecraft.getMinecraft()
                        .getTextureManager(),
                    world,
                    posX,
            ...
            case 6:
                ...
                break;
            case 7:
                ParticleMush mush = new ParticleMush(
                    Minecraft.getMinecraft()
                        .getTextureManager(),
                    world,
                    posX,
        ...
        switch (type) {
            ...
            case SFX_RAILGUN:
                ...
                for (int i = 0; i < pow; i++) {
                    ...
                    Vec3 vec = Vec3
                        .createVectorHelper(((Vec3) payload).xCoord, ((Vec3) payload).yCoord, ((Vec3) payload).zCoord);
                    ...
                    EntityFireworkSparkFX blast = new EntityFireworkSparkFX(
                        world,
                        posX,
                        posY,
                        posZ,
                    ...
                    if (world.rand.nextBoolean()) blast.setColour(0x0088EA);
                    else blast.setColour(0x52A8E6);
            ...
            case SFX_BORDER:
                ...
                for (int i = 0; i < a; i++) {
                    ...
                    double ys = world.getHeightValue((int) xs, (int) zs - 1) + 0.25;// + 1.5D +
                    ...
                    EntityFireworkSparkFX blast = new EntityFireworkSparkFX(
                        ...
                        zs,
                        0.0,
                        0.4 * world.rand.nextGaussian() + 0.6,
                        0.0,
                        Minecraft.getMinecraft().effectRenderer);
        ...
        if (type.equals("resources")) {
            ...
            try {
                ...
                for (int i = 0; i < strength * 10; i++) {
                    ...
                    EntityFlameFX flames = new EntityFlameFX(
                        world,
                        x,
                        y,
                        z,
                ...
                for (int i = 0; i < strength * 25; i++) {
                    ...
                    ReflectionHelper.setPrivateValue(
                        Entity.class,
                        flames,
                        world.rand.nextDouble() * 0.25 * strength,
                        "motionY",
                        "field_70181_x");
                    ReflectionHelper.setPrivateValue(
                        Entity.class,
                ...
                for (int i = 0; i < strength * 50; i++) {
                    ...
                    EntityCloudFX flames = new EntityCloudFX(
                        world,
                        x,
                        y,
                        z,
