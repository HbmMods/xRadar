...
public class MainRegistry {
    ...
    public static DamageSource blast = (new DamageSource("blast")).setExplosion()
        ...
        .setDamageIsAbsolute();
    public static DamageSource zyklon = (new DamageSource("zyklon")).setDamageBypassesArmor()
        .setDamageIsAbsolute();
    ...
    public void PreLoad(FMLPreInitializationEvent PreEvent) {
        if (logger == null) logger = PreEvent.getModLog();
        ...
        EntityRegistry
            .registerModEntity(EntityMissileIncendiary.class, "entity_missile_v2F", id++, this, 1000, 1, true);
        EntityRegistry.registerModEntity(EntityMissileStrong.class, "entity_missile_large", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityMissileIncendiaryStrong.class, "entity_missile_largeF", id++, this, 1000, 1, true);
        EntityRegistry.registerModEntity(EntityMissileBurst.class, "entity_missile_korea", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityMissileInferno.class, "entity_missile_koreaF", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityMissileAntiBallistic.class, "entity_missile_anti", id++, this, 1000, 1, true);
        EntityRegistry.registerModEntity(EntityMissileEMPStrong.class, "entity_missile_emp", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityNukeCloudSmall.class, "entity_mushroom_cloud", id++, this, 1000, 1, true);
        EntityRegistry.registerModEntity(EntityMissileDecoy.class, "entity_missile_decoy", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityMissileNuclear.class, "entity_missile_nuclear", id++, this, 1000, 1, true);
        ...
        EntityRegistry
            .registerModEntity(EntityGrenadeNuclear.class, "entity_hfr_nuke_grenade", id++, this, 1000, 1, true);
        EntityRegistry
            .registerModEntity(EntityGrenadeBoxcar.class, "entity_hfr_grb_grenade", id++, this, 1000, 1, true);
        ...
        EntityRegistry
            .registerModEntity(EntityMissilePegasus.class, "entity_missile_pegasus", id++, this, 1000, 1, true);
        ...
        EntityRegistry
            .registerModEntity(EntityMissileCruise1.class, "entity_missile_cruise1", id++, this, 1000, 1, true);
    ...
    public void loadConfig(FMLPreInitializationEvent event) {
        ...
        enableRadar = this.createConfigBool(
            config,
            "RADAR",
            "FxR_enableRadar",
        ...
        Property propFree = config.get(Configuration.CATEGORY_GENERAL, "freeRadar", false)
        ...
        Property propSound = config.get("RADAR", "radarPing", true)
            .setDefaultValue(true);
        propSound.comment = "Whether or not the radar makes frequent pinging sounds";
        sound = propSound.getBoolean();

        Property propComp = config.get("RADAR", "comparatorOutput", false)
            .setDefaultValue(false);
        ...
        Property propAF = config.get("FORCEFIELD", "useFlanSpecialCase", true)
            .setDefaultValue(true);
        ...
        Property drywall = config.get(
            "MISSILE",
            "blastShields",
            new String[] { "" + Block.getIdFromBlock(Blocks.obsidian), "" + Block.getIdFromBlock(ModBlocks.concrete),
                "" + Block.getIdFromBlock(ModBlocks.concrete_bricks), "" + Block.getIdFromBlock(ModBlocks.vault_door),
        ...
        coalRate = createConfigInt(
            config,
            "COALMINE",
            "coalRate",
            "Average amount of seconds for mine to generate coal",
            60);
        coalJamRate = createConfigInt(
            config,
            "COALMINE",
            "accidentRate",
        ...
        coalgenProduction = createConfigInt(
            config,
            "COALGEN",
            "coalgenProduction",
            "How much RF the coal generator produces per tick",
            200);
        windmillProduction = createConfigInt(
            config,
            "WINDTURBINE",
            "windturbineProduction",
            "How much RF the wind turbine produces per tick",
            500);
        waterwheelProduction = createConfigInt(
            config,
            "WATERMILL",
            "watermillProduction",
            "How much RF the water mill produces per tick",
            100);
        dieselProduction = createConfigInt(
            config,
            "DIESELGEN",
            "dieselProduction",
        ...
        Property pAids = config.get("SKELETON", "explosiveArrows", false)
            .setDefaultValue(false);
        pAids.comment = "Whether or not skeleton arrows should be explosive";
        skeletonAIDS = pAids.getBoolean();

        Property pHiv = config.get("SKELETON", "arrowStrength", 1.5)
            .setDefaultValue(1.5);
        ...
        /////////////////////////////////////////////////////////////////////////
        Property stocks = config.get(
            "STOCKMARKET",
            "stocks",
            new String[] { "Bobcum Motors:CUM:50:2.5:7.5:10:7.5:2.5", "Bingus International:BIN:50:2.5:7.5:10:7.5:2.5",
                "Spark Corporation:SPK:50:2.5:7.5:10:7.5:2.5", "FlimFlam Industries:FLIM:50:2.5:7.5:10:7.5:2.5",
                "Magpie Electricals:MAG:50:2.5:7.5:10:7.5:2.5", "Papa G Softworks:PAPA:50:2.5:7.5:10:7.5:2.5" });
        ...
        /////////////////////////////////////////////////////////////////////////
        String[] u2 = createConfigStringList(
            config,
            "STOCKMARKET",
            "u2messages",
            "Broadcast for econ boosts, %s replaces company short",
            new String[] { "%s's newest product proved to be a smash hit!", "%s is doing very well this quarter!" });

        for (String val : u2) {

            if (val.contains("%s")) this.u2.add(val);
            else logger.error("Invalid config entry '" + val + "'");
        }

        String[] u1 = createConfigStringList(
            config,
            "STOCKMARKET",
            "u1messages",
            "Broadcast for small econ boosts, %s replaces company short",
            new String[] { "%s's newest product was featured in a famous television show!",
                "Customer ratings for %s's services are on the rise!" });

        for (String val : u1) {

            if (val.contains("%s")) this.u1.add(val);
            else logger.error("Invalid config entry '" + val + "'");
        }

        String[] d1 = createConfigStringList(
            config,
            "STOCKMARKET",
            "d1messages",
            "Broadcast for small econ falls, %s replaces company short",
            new String[] { "%s's newest product was poorly received.", "%s lost a lawsuit over a faulty product." });

        for (String val : d1) {

            if (val.contains("%s")) this.d1.add(val);
            else logger.error("Invalid config entry '" + val + "'");
        }

        String[] d2 = createConfigStringList(
            config,
            "STOCKMARKET",
            "d2messages",
            "Broadcast for econ falls, %s replaces company short",
            new String[] { "%s's newest product was an utter flop.",
                "Public outrage after a poor advertising campaign made by %s." });

        for (String val : d2) {

            if (val.contains("%s")) this.d2.add(val);
            else logger.error("Invalid config entry '" + val + "'");
        }

        String[] flags = createConfigStringList(
            config,
            "CLOWDER",
            "flags",
        ...
        for (String val : flags) {
            ...
            try {
                ...
                EnumHelper.addEnum(
                    ...
                    new Object[] { fname, vis, base, over });
        ...
        surfaceMobs = createConfigBool(
            config,
            "ENTITYCONTROL",
            "surfaceMobs",
            "Forces hostiles to spawn on the surface",
            true);
        zombMiningMult = createConfigDouble(
            config,
            "ENTITYCONTROL",
            "zombMiningMult",
    ...
    private static double createConfigDouble(Configuration config, String category, String name, String comment,
        double def) {
    ...
    private static void processBuffer() {
        for (String name : twilightBuffer) {
            ...
            try {
                ...
                if (b != null) zombBlacklist.add(b);
                else logger.error("Invalid block entry '" + name + "'");
        ...
        for (Integer i : t2Buffer) {
            ...
            if (b != Blocks.air) blastShields.add(b);
        }
    }
    ...
    public static class ControlEntry {
        ...
        public static int getEntry(Entity e) {
            ...
            for (ControlEntry ent : controlList) {
                if (ent.entity.equals(EntityList.getEntityString(e))) return ent.chance;
            }
    ...
    public static class ImmunityEntry {
        ...
        public static List<String> getEntry(Entity e) {
            ...
            for (ImmunityEntry ent : immunityList) {
                if (ent.entity.equals(EntityList.getEntityString(e))) list.add(ent.damage);
            }
