...
public class ParticleContrail extends EntityFX {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        RefStrings.MODID + ":textures/particle/contrail.png");
    private TextureManager theRenderEngine;
    private int age;
    private int maxAge;

    public ParticleContrail(TextureManager p_i1213_1_, World p_i1218_1_, double p_i1218_2_, double p_i1218_4_,
        double p_i1218_6_) {
    ...
    public ParticleContrail(TextureManager p_i1213_1_, World p_i1218_1_, double p_i1218_2_, double p_i1218_4_,
        double p_i1218_6_, float red, float green, float blue, float scale) {
        super(p_i1218_1_, p_i1218_2_, p_i1218_4_, p_i1218_6_);
        theRenderEngine = p_i1213_1_;
        maxAge = 100 + rand.nextInt(40);
    ...
    public void renderParticle(Tessellator p_70539_1_, float p_70539_2_, float p_70539_3_, float p_70539_4_,
        ...
        for (int i = 0; i < 6; i++) {
            ...
            p_70539_1_.setColorRGBA_F(
                this.particleRed + mod,
                this.particleGreen + mod,
                this.particleBlue + mod,
                this.particleAlpha);
            ...
            p_70539_1_.addVertexWithUV(
                (double) (pX - p_70539_3_ * scale - p_70539_6_ * scale),
                (double) (pY - p_70539_4_ * scale),
                (double) (pZ - p_70539_5_ * scale - p_70539_7_ * scale),
                1,
                1);
            p_70539_1_.addVertexWithUV(
                (double) (pX - p_70539_3_ * scale + p_70539_6_ * scale),
