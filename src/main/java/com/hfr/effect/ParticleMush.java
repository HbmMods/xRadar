...
public class ParticleMush extends EntityFX {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        RefStrings.MODID + ":textures/particle/mush.png");
    private TextureManager theRenderEngine;
    private int age;
    private int maxAge;

    public ParticleMush(TextureManager p_i1213_1_, World p_i1218_1_, double p_i1218_2_, double p_i1218_4_,
        double p_i1218_6_) {
    ...
    public void renderParticle(Tessellator tessellaator, float p_70539_2_, float x, float y, float z, float sx,
        float sz) {
        ...
        tessellaator.addVertexWithUV(
            (double) (pX - x * scale - sx * scale),
            (double) (pY - y * scale),
            (double) (pZ - z * scale - sz * scale),
            1,
            (prog + 1) * frame);
        tessellaator.addVertexWithUV(
            (double) (pX - x * scale + sx * scale),
