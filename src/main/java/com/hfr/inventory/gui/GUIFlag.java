...
public class GUIFlag extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        if (prestigeReq <= prestige) color = 0x008000;
        ...
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 17 < y && guiTop + 17 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(new String[] { "Requires 3 prestige", "Claims land in a 10 chunk radius" }),
                x - guiLeft,
                y - guiTop);
        }
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 35 < y && guiTop + 35 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(new String[] { "Requires 2 prestige", "Claims land in a 5 chunk radius" }),
                x - guiLeft,
                y - guiTop);
        }
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 53 < y && guiTop + 53 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(new String[] { "Requires 1 prestige", "Claims land in a 1 chunk radius" }),
                x - guiLeft,
                y - guiTop);
        }
        if (guiLeft + 133 <= x && guiLeft + 133 + 18 > x && guiTop + 52 < y && guiTop + 52 + 18 >= y) {
            ...
            else this.func_146283_a(Arrays.asList(new String[] { "Active" }), x - guiLeft, y - guiTop);
        }
    }
    ...
    protected void mouseClicked(int x, int y, int i) {
        ...
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 17 < y && guiTop + 17 + 18 >= y) {
            ...
            PacketDispatcher.wrapper
                .sendToServer(new AuxButtonPacket(diFurnace.xCoord, diFurnace.yCoord, diFurnace.zCoord, 0, 0));
            mc.getSoundHandler()
        ...
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 35 < y && guiTop + 35 + 18 >= y) {
            ...
            PacketDispatcher.wrapper
                .sendToServer(new AuxButtonPacket(diFurnace.xCoord, diFurnace.yCoord, diFurnace.zCoord, 0, 1));
            mc.getSoundHandler()
                .playSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"), 1.0F));
        }
        ...
        if (guiLeft + 25 <= x && guiLeft + 25 + 18 > x && guiTop + 53 < y && guiTop + 53 + 18 >= y) {
            ...
            PacketDispatcher.wrapper
                .sendToServer(new AuxButtonPacket(diFurnace.xCoord, diFurnace.yCoord, diFurnace.zCoord, 0, 2));
            mc.getSoundHandler()
                .playSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"), 1.0F));
        }
         ...
         * PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(diFurnace.xCoord, diFurnace.yCoord,
         * diFurnace.zCoord, 0, 3));
         * mc.getSoundHandler().playSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"),
         * 1.0F));
         * }
         */
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (diFurnace.height < 1.0F) drawTexturedModalRect(guiLeft + 133, guiTop + 52, 176, 72, 18, 18);
        else if (i > 0) drawTexturedModalRect(guiLeft + 133, guiTop + 52, 176, 108, 18, 18);
        else drawTexturedModalRect(guiLeft + 133, guiTop + 52, 176, 90, 18, 18);

        if (isPressed()) drawTexturedModalRect(guiLeft + 133, guiTop + 16, 176, 54, 18, 18);
    }
