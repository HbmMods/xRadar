...
public class GUIMachineMarket extends GuiScreen {
            ...
            if (guiLeft + 133 <= x && guiLeft + 133 + 18 > x
                ...
                if (offer != null) {
                    PacketDispatcher.wrapper.sendToServer(
                        new AuxButtonPacket(market.xCoord, market.yCoord, market.zCoord, (page - 1) * 6 + j, 999));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        if (market == null || market.isInvalid()) this.mc.thePlayer.closeScreen();
    }
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        ...
        this.fontRendererObj
            .drawString(s, guiLeft + this.xSize / 2 - this.fontRendererObj.getStringWidth(s) / 2, guiTop + 10, 4210752);
        ...
        if (last != null) this.renderToolTip(last, i, j);
    }
            ...
            if (offer != null) {
                ...
                for (int l = 1; l < 4; l++) {
                    ...
                    if (offer[l] != null) {
                        ...
                        if (posX < x && posX + 16 > x && posY < y && posY + 16 > y) last = offer[l];
                ...
                RenderHelper.disableStandardItemLighting();
                itemRender
                    .renderItemAndEffectIntoGUI(fontRendererObj, this.mc.getTextureManager(), offer[0], posX, posY);
                itemRender.renderItemOverlayIntoGUI(fontRendererObj, this.mc.getTextureManager(), offer[0], posX, posY);

                if (posX < x && posX + 16 > x && posY < y && posY + 16 > y) last = offer[0];
            }
        }
    }
