...
public class GUITurbine extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        String name = this.diFurnace.hasCustomInventoryName() ? this.diFurnace.getInventoryName()
            : I18n.format(this.diFurnace.getInventoryName());
        ...
        if (guiLeft + 7 <= x && guiLeft + 7 + 18 > x && guiTop + 16 < y && guiTop + 16 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(
                    new String[] { "DISCARD ALL WATER", "Not recommended for setups that",
                        "require a water cycle. Since there's no", "water coming out, you know." }),
                x - guiLeft,
                y - guiTop);
        }
        ...
        if (guiLeft + 7 <= x && guiLeft + 7 + 18 > x && guiTop + 34 < y && guiTop + 34 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(
                    new String[] { "DISCARD WATER WHEN FULL", "May lead to water deficit", "when overloaded." }),
                x - guiLeft,
                y - guiTop);
        }
        ...
        if (guiLeft + 7 <= x && guiLeft + 7 + 18 > x && guiTop + 52 < y && guiTop + 52 + 18 >= y) {
            this.func_146283_a(
                Arrays.asList(
                    new String[] { "STOP TURBINE WHEN FULL", "Necessary for setups that",
                        "completely rely on the water cycle." }),
                x - guiLeft,
                y - guiTop);
        }
        ...
        if (guiLeft + 44 <= x && guiLeft + 44 + 16 > x && guiTop + 17 < y && guiTop + 17 + 52 >= y) {
            this.func_146283_a(
                Arrays.asList(new String[] { "Steam:", diFurnace.steam.getFluidAmount() + "mB" }),
                x - guiLeft,
                y - guiTop);
        }
        ...
        if (guiLeft + 80 <= x && guiLeft + 80 + 16 > x && guiTop + 17 < y && guiTop + 17 + 52 >= y) {
            this.func_146283_a(
                Arrays.asList(new String[] { "Water:", diFurnace.water.getFluidAmount() + "mB" }),
                x - guiLeft,
                y - guiTop);
        }
    }
