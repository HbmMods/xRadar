...
public class GUIScreenSLBM extends GuiScreen {
    ...
    protected static final ResourceLocation texture = new ResourceLocation(
        RefStrings.MODID + ":textures/gui/gui_slbm.png");
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        ...
        itemRenderer.renderItemAndEffectIntoGUI(
            ...
            new ItemStack(SLBMHandler.getMissileFromClient()),
            guiLeft + 35,
            guiTop + 35);
    ...
    // handles characters being typed into the text field, the gui being closed and keyboard controls for the gui
    // elements
