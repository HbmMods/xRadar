...
public class GUIMachineOilWell extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        String name = this.derrick.hasCustomInventoryName() ? this.derrick.getInventoryName()
            : I18n.format(this.derrick.getInventoryName());
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (k == 2) drawTexturedModalRect(guiLeft + 44, guiTop + 18, 176, 52, 16, 16);
        if (k == 1) drawTexturedModalRect(guiLeft + 44, guiTop + 18, 192, 52, 16, 16);
