...
public class ContainerCoalMine extends Container {
    ...
    public ContainerCoalMine(InventoryPlayer invPlayer, TileEntityMachineCoalMine tedf) {
        ...
        // Miners
        for (int i = 0; i < 5; i++) this.addSlotToContainer(new Slot(tedf, i, 8 + 18 * i, 17));
        ...
        // Coal
        for (int i = 0; i < 5; i++) this.addSlotToContainer(new LockedSlot(tedf, i + 7, 80 + 18 * i, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int par2) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (par2 <= 12) {
                ...
                if (!this.mergeItemStack(var5, 0, 7, false)) return null;
            }
