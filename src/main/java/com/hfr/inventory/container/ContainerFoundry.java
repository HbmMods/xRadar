...
public class ContainerFoundry extends Container {
    ...
    public ContainerFoundry(InventoryPlayer invPlayer, TileEntityFoundry te) {
        ...
        // Bottle
        this.addSlotToContainer(new LockedSlot(te, 2, 116, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int par2) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (par2 <= 2) {
                ...
                if (!this.mergeItemStack(var5, 0, 2, false)) return null;
            }
