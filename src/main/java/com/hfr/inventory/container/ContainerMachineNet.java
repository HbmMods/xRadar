...
public class ContainerMachineNet extends Container {

    private TileEntityMachineNet diFurnace;

    public ContainerMachineNet(InventoryPlayer invPlayer, TileEntityMachineNet tedf) {
        ...
        // Jammed Slot
        this.addSlotToContainer(new LockedSlot(tedf, 4, 134, 35));
