...
public class ContainerBlastFurnace extends Container {
    ...
    public ContainerBlastFurnace(InventoryPlayer invPlayer, TileEntityMachineBlastFurnace tedf) {
        ...
        // Iron
        for (int i = 0; i < 3; i++) this.addSlotToContainer(new Slot(tedf, i, 26 + 18 * i, 17));
        // Steel
        for (int i = 0; i < 3; i++) this.addSlotToContainer(new LockedSlot(tedf, i + 3, 98 + 18 * i, 35));
        // Coal
        this.addSlotToContainer(new Slot(tedf, 6, 44, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int par2) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (par2 <= 6) {
                ...
                if (!this.mergeItemStack(var5, 0, 3, false)) if (!this.mergeItemStack(var5, 6, 7, false)) return null;
            }
