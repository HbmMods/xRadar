...
public class ContainerNaval extends Container {
	
	private TileEntityNaval diFurnace;
	
	public ContainerNaval(InventoryPlayer invPlayer, TileEntityNaval tedf) {
		...
		//targeter
		this.addSlotToContainer(new Slot(tedf, 1, 53, 17));
		//ammo
