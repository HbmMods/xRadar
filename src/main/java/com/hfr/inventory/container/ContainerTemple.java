...
public class ContainerTemple extends Container {

    private TileEntityMachineTemple diFurnace;

    public ContainerTemple(InventoryPlayer invPlayer, TileEntityMachineTemple tedf) {

        diFurnace = tedf;

        // Scrolls
        this.addSlotToContainer(new LockedSlot(tedf, 0, 80, 35));
