...
public class ContainerMachineOilWell extends Container {
    ...
    private TileEntityMachineDerrick testNuke;
    private int warning;
    private int warning2;

    public ContainerMachineOilWell(InventoryPlayer invPlayer, TileEntityMachineDerrick tedf) {
        warning = 0;
        warning2 = 0;
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int par2) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (par2 <= 5) {
                ...
                if (!this.mergeItemStack(var5, 3, 4, false)) if (!this.mergeItemStack(var5, 5, 6, false)) return null;
            }
