...
public class EntityNukeCloudSmall extends Entity {
    ...
    public void onUpdate() {
        // super.onUpdate();
        this.age++;
        // this.worldObj.spawnEntityInWorld(new EntityLightningBolt(this.worldObj, this.posX, this.posY + 400,
        // this.posZ));
    ...
    public static EntityNukeCloudSmall statFac(World world, double x, double y, double z) {

        EntityNukeCloudSmall cloud = new EntityNukeCloudSmall(
            world,
            MainRegistry.mushLife,
            MainRegistry.mushScale * 0.005F);
        cloud.posX = x;
        cloud.posY = y;
        cloud.posZ = z;
