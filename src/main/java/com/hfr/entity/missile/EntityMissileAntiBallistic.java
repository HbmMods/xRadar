...
public class EntityMissileAntiBallistic extends Entity implements IChunkLoader, IEmpable {
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (movement.lengthVector() < 0.1 || this.ticksExisted > 30 * 20) this.setDead();
        }
    ...
    private void targetMissile() {
        ...
        List<Entity> list = worldObj.getEntitiesWithinAABBExcludingEntity(
            ...
            AxisAlignedBB.getBoundingBox(
                posX - MainRegistry.abRange,
                0,
                posZ - MainRegistry.abRange,
                posX + MainRegistry.abRange,
                6000,
                posZ + MainRegistry.abRange));
        ...
        if (target != null) {
            ...
            if (posY > 5000 && !worldObj.isRemote) this.setDead();
        }
    }
