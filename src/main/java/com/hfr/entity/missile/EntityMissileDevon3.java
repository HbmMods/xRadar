...
public class EntityMissileDevon3 extends EntityMissileBaseCruise {

    public EntityMissileDevon3(World p_i1582_1_) {
        super(p_i1582_1_);
    }

    public EntityMissileDevon3(World world, float x, float y, float z, int a, int b) {
    ...
    public void onImpact() {
        ...
        worldObj.spawnEntityInWorld(
            EntityBlast
                .statFac(worldObj, posX, posY, posZ, MainRegistry.t3blast, MainRegistry.t3Damage, 15, 20, false));
    }
    ...
    public void onForceImpact() {
        super.onForceImpact();
        worldObj.spawnEntityInWorld(
            EntityBlast.statFac(worldObj, posX, posY, posZ, MainRegistry.t3blast, MainRegistry.t3Damage, 0, 0, false));
    }
