    ...
    public void onUpdate() {
        ...
        if (movingobjectposition != null) {
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (raiding) worldObj.spawnEntityInWorld(
                    EntityBlast.statFac(worldObj, posX, posY, posZ, 45, MainRegistry.navalDamage, 5, 3, false));
                else worldObj.spawnEntityInWorld(
                    EntityBlast.statFac(worldObj, posX, posY, posZ, 45, MainRegistry.navalDamage, 0, 0, false));
            }
            this.setDead();
            return;
        }
