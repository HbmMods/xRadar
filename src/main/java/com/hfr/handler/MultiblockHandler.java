...
public class MultiblockHandler {
    ...
    public static boolean checkSpace(World world, int x, int y, int z, int[] dim, int ox, int oy, int oz,
        ForgeDirection dir) {
        ...
        for (int a = x - rot[4]; a <= x + rot[5]; a++) {
            for (int b = y - rot[1]; b <= y + rot[0]; b++) {
                for (int c = z - rot[2]; c <= z + rot[3]; c++) {
                    ...
                    if (!world.getBlock(a, b, c)
                        .canPlaceBlockAt(world, a, b, c)) {
                        return false;
                    }
        ...
        for (int a = x - rot[4]; a <= x + rot[5]; a++) {
            for (int b = y - rot[1]; b <= y + rot[0]; b++) {
                for (int c = z - rot[2]; c <= z + rot[3]; c++) {
                    ...
                    if (world.getBlock(a, b, c) == block) world.setBlockToAir(a, b, c);
