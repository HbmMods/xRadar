...
public class ItemCassette extends Item {
	...
	public enum TrackType {
		...
		CONTAINER_ALARM(	"Container Alarm", 			new ResourceLocation("hfr:alarm.containerAlarm"),	SoundType.LOOP,		14727839,	100),
		SWEEP_SIREN(		"Sweep Siren", 				new ResourceLocation("hfr:alarm.sweepSiren"),		SoundType.LOOP,		15592026,	500),
		STRIDER_SIREN(		"Missile Silo Siren", 		new ResourceLocation("hfr:alarm.striderSiren"),		SoundType.LOOP,		11250586,	500),
