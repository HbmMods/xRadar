...
public class ItemCapsule extends Item {
    ...
    public void onUpdate(ItemStack stack, World world, Entity entity, int i, boolean b) {
        ...
        if (!world.isRemote) {
            ...
            if (timer <= 200) setTimer(stack, timer);
            ...
            if (timer == 200) {
                ...
                for (int k = 0; k < 15; k++) {
                    world.createExplosion(
                        null,
                        entity.posX + entity.worldObj.rand.nextGaussian(),
                        entity.posY + entity.worldObj.rand.nextDouble() + entity.height,
                        entity.posZ + entity.worldObj.rand.nextGaussian(),
                        2,
                        false);
                }
