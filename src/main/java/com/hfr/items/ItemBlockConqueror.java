    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        ...
        if (movingobjectposition == null) {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (p_77659_2_.getBlock(i, j, k)
                    .getMaterial() == Material.water && p_77659_2_.getBlockMetadata(i, j, k) == 0
                    ...
                    if (net.minecraftforge.event.ForgeEventFactory
                        .onPlayerBlockPlace(p_77659_3_, blocksnapshot, net.minecraftforge.common.util.ForgeDirection.UP)
                        .isCanceled()) {
