...
public class ItemDebug extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        if (!world.isRemote && player instanceof EntityPlayerMP) {
            ...
            if (!player.isSneaking()) thePlayer.mcServer.getConfigurationManager()
                .transferPlayerToDimension(thePlayer, 15, new MoonTeleporter(thePlayer.getServerForPlayer()));
            else System.out.println(player.dimension);
        }
