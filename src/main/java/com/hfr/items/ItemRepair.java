...
public class ItemRepair extends Item {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
        ...
        if (this == ModItems.repair_1) list.add("It's like a band-aid, but for walls!");
        if (this == ModItems.repair_2) list.add("Basically rock glue");
        if (this == ModItems.repair_3) list.add("Comes with enough glue to make the plate stick");
