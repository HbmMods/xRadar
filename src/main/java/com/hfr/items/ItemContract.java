...
public class ItemContract extends Item {
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        for (int i = 0; i < 3; i++) list.add(new ItemStack(ModItems.farmer, 1, i));
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
        ...
        switch (stack.getItemDamage()) {
            case 0:
                list.add("O'Brien - Extra Potato Yield");
                break;
            case 1:
                list.add("Nghiêm - Can Harvest Sugar Cane, Extra Rice Yield");
                break;
            case 2:
                list.add("Davis - Can Harvest Melons and Pumpkins");
                break;
        }
    }
