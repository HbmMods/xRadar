    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        if (clowder == null) {
            player.getEntityData()
                .setInteger(CHAT_KEY, 0);
            sender.addChatMessage(
                new ChatComponentText(CRITICAL + "You are not in any faction, chat settings have been reset!"));
            return;
        }
         ...
         * "You can't message your faction without a message! (duh)"));
         * return;
         * }
         * if(clowder == null) {
