                    ...
                    sender.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.DARK_GRAY
                                + "========================================================="));
                    sender.addChatMessage(
                        new ChatComponentText(EnumChatFormatting.DARK_GRAY + "" + sdf.format(logout) + " /logout"));
                    sender.addChatMessage(
                        new ChatComponentText(EnumChatFormatting.DARK_GRAY + "" + sdf.format(current) + " /current"));
