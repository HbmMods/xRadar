...
public class CommandXPlayer extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        if (args.length != 2) {
            ...
            if (!"cbt".equals(args[0]) && !"ramranch".equals(args[0])
                && !"fps".equals(args[0])
                && !"tilt".equals(args[0])
                && !"shader".equals(args[0])
                && !"vomit".equals(args[0])) {
                ...
                sender.addChatMessage(
                    new ChatComponentText(EnumChatFormatting.RED + "  -ramranch OR tilt (screen gymnastics)"));
                sender.addChatMessage(
                    new ChatComponentText(
                        EnumChatFormatting.RED + "  -vomit OR shader (rapidly alternaating shaders)"));
                return;
            }
            ...
            if (target != null) {
                ...
                if ("cbt".equals(args[0]) || "fps".equals(args[0])) {
                    ...
                    else sender.addChatMessage(new ChatComponentText("Disabled low-FPS mode for player " + args[1]));
                    ...
                    else sender.addChatMessage(new ChatComponentText("Disabled tilt mode for player " + args[1]));
                    ...
                    else sender.addChatMessage(new ChatComponentText("Disabled shader mode for player " + args[1]));
                }
