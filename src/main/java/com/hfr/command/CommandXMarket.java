            ...
            if (args[0].equals("setstock")) {
                ...
                if (args.length != 3) {
                    sender.addChatMessage(
                        new ChatComponentText(EnumChatFormatting.RED + "/xmarket setstock [shortname] [value]"));
                } else {
                    ...
                    if (setstock == null) {
                        sender.addChatMessage(
                            new ChatComponentText(EnumChatFormatting.RED + "'" + args[1] + "' is not a valid stock!"));
                        return;
                    }
                    ...
                    if (setamount > 0 && setamount < 100) {
                        ...
                        sender.addChatMessage(
                            new ChatComponentText(
                                EnumChatFormatting.GREEN + "" + args[1] + " has been set to " + setamount + "!"));

                    } else {
                        sender.addChatMessage(
                            new ChatComponentText(
                                EnumChatFormatting.RED + "'" + setamount + "' is out of range or invalid!"));
                    }
                }
                ...
                if (args.length != 3) {
                    sender.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.RED + "/xmarket triggerstock [shortname] [N|U2|U1|D1|D2]"));
                } else {
                    ...
                    if (phase != null) {
                        ...
                        sender.addChatMessage(
                            new ChatComponentText(
                                EnumChatFormatting.GREEN + "" + args[1] + "'s phase has been set to " + args[2] + "!"));

                    } else {
                        sender.addChatMessage(
                            new ChatComponentText(EnumChatFormatting.RED + "'" + args[2] + "' is not a valid phase!"));
                    }
                }
                ...
                if (args.length != 4) {
                    sender.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.RED + "/xmarket setshares [shortname] [player] [amount]"));
                } else {
                    ...
                    if (shares < 0) {
                        sender.addChatMessage(
                            new ChatComponentText(
                                EnumChatFormatting.RED + "'" + shares + "' is out of range or invalid!"));
                        return;
                    }
                    ...
                    sender.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.GREEN + "Player "
                ...
                if (args.length != 3) {
                    sender.addChatMessage(
                        new ChatComponentText(EnumChatFormatting.RED + "/xmarket getshares [shortname] [player]"));
                } else {
